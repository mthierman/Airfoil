...
export default (theme: Theme) => {
    return {
        ...
        colors: {
            ...
            "debugConsole.errorForeground": theme.tailwind.red[theme.scale],
            "debugConsole.infoForeground": theme.tailwind.amber[theme.scale],
            "debugConsole.sourceForeground": theme.tailwind.blue[theme.scale],
            "debugConsole.warningForeground": theme.tailwind.yellow[theme.scale],
