import type { Accent, Mode, Tone, WorkbenchColors } from "../modules/themes.mjs";
import { accents, colorsToHex, makeTerminal, makeTheme, modes, tones } from "../modules/themes.mjs";
...
export const generateTheme = (mode: Mode, tone: Tone, accent: Accent) => {
    ...
    const colors: WorkbenchColors = {
        ...
        "editorBracketPairGuide.activeBackground1": tw.orange[key.scale],
        "editorBracketPairGuide.activeBackground2": tw.yellow[key.scale],
        "editorBracketPairGuide.activeBackground3": tw.cyan[key.scale],
        "editorBracketPairGuide.activeBackground4": tw.blue[key.scale],
        "editorBracketPairGuide.activeBackground5": tw.purple[key.scale],
        "editorBracketPairGuide.activeBackground6": tw.pink[key.scale],
